      ...
      <head>
        ...
        <style>
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .gov-header { display: flex; align-items: center; gap: 20px; border-bottom: 3px solid #1E3A8A; padding-bottom: 18px; margin-bottom: 24px; }
          .gov-emblem { width: 72px; height: 72px; background: #1E3A8A; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: #fff; font-size: 28px; flex-shrink: 0; }
