export const translations = {
  en: {
    ...
    arrivingFromPlaceholder: "Enter your city, village or area",
  ...
  mr: {
    ...
    continue:            "पुढे जा →",
    back:                "← मागे",
    arrivingFrom:        "कुठून येणार आहात",
    arrivingFromPlaceholder: "तुमचे शहर, गाव किंवा परिसर लिहा",
  ...
  hi: {
    ...
    continue:            "आगे बढ़ें →",
    back:                "← पीछे",
    arrivingFrom:        "कहाँ से आ रहे हैं",
    arrivingFromPlaceholder: "अपना शहर, गाँव या क्षेत्र लिखें",
